...
puts ""
puts " ::::Usage::::					".cyan
puts "[>]  Proxy    : run tor command in xterm ".cyan
puts "[>]  Fuzz     : 'fuzz' is a string for payload to inject  			".cyan
puts "[>]  Usage(s) : ruby maaviproxy.rb fuzzpayloads https://www.example.com/?id=fuzz	".cyan
puts "[>]  Usage(s) : ruby maaviproxy.rb fuzzpayloads https://www.example.com/fuzz	        ".cyan
puts "[>]  Usage(s) : ruby maaviproxy.rb fuzzpayloads https://www.example.com/index.php/fuzz ".cyan
puts "[>]  Usage(s) : ruby maaviproxy.rb fuzzpayloads https://www.example.com/index.php#fuzz ".cyan
...
browser = Watir::Browser.new :firefox, proxy: proxy_hash
domxssfile = ARGV[0]
victim = ARGV[1]
